...
export const SelectedAccountColumns = [
  { name: 'Date', class: 'flex-[0_0_11%] text-left' },
  { name: 'Payee', class: 'flex-[0_0_19.666%] text-left' },
  { name: 'Category', class: 'flex-[0_0_19.666%] text-left' },
  { name: 'Memo', class: 'flex-[0_0_19.666%] text-left' },
  { name: 'Outflow', class: 'flex-[0_0_10%] text-left' },
  { name: 'Inflow', class: 'flex-[0_0_10%] text-right' },
  { name: 'Balance', class: 'flex-[0_0_10%] text-right' },
];

export const AllAccountsColumns = [
  { name: 'Account', class: 'flex-[0_0_10%] text-left' },
  { name: 'Date', class: 'flex-[0_0_11%] text-left' },
  { name: 'Payee', class: 'flex-[0_0_20.33%] text-left' },
  { name: 'Category', class: 'flex-[0_0_20.33%] text-left' },
  { name: 'Memo', class: 'flex-[0_0_20.33%] text-left' },
  { name: 'Outflow', class: 'flex-[0_0_9%] text-left' },
  { name: 'Inflow', class: 'flex-[0_0_9%] text-right' },
];
